        ...
        <div class="col-lg-8 me-auto">
          <div class="breadcrumb-content">
            ...
            <div class="bread-btn-box pt-3">
              <button
                class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 me-2 mb-2"
              >
              ...
              <button
                class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 mb-2"
                data-bs-toggle="modal"
          ...
          <div class="col-lg-8 pb-5">
            <div class="course-details-content-wrap pt-90px">
              ...
              <div class="course-overview-card">
                  ...
                  <div class="curriculum-duration fs-15">
                    <span class="curriculum-total__text me-2"
                      ><strong class="text-black font-weight-semi-bold"
                        >Total:</strong
                      >
                      {{ count($course_lectures) }} lectures</span
                    >
                ...
                @php
                    $course_sections = App\Models\CourseSection::where('course_id', $course->id)->orderBy('id','asc')->get();
                @endphp
                    ...
                    <div class="card">
                      ...
                      <div class="card-header" id="heading{{ $course_section->id }}">
                        <button
                          ...
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse{{ $course_section->id }}"
                          aria-expanded="true"
                          aria-controls="collapse{{ $course_section->id }}"
                        >
                  ...
                  <div class="media media-card">
                    ...
                    <div class="media-body">
                      ...
                      <span class="d-block lh-18 pt-2 pb-3"
                        >Joined {{ Carbon\Carbon::parse($course->user->created_at)->diffForHumans() }}</span
                      >
              ...
              <div class="course-overview-card pt-4">
                ...
                <div class="review-wrap">
                  ...
                  >
                    ...
                    <div class="media-body">
                      <div
                        class="d-flex flex-wrap align-items-center justify-content-between pb-1"
                      >
                        <h5>Kavi arasan</h5>
                        <div class="review-stars">
                          <span class="la la-star"></span>
              ...
              <div class="card card-item">
                <div class="card-body">
                  ...
                  <ul class="generic-list-item generic-list-item-flash">
                    ...
                    >
                      <span
                        ><i class="la la-clock me-2 text-color"></i
                        >Duration</span
                      >
                    ...
                    >
                      <span
                        ><i class="la la-file-text-o me-2 text-color"></i
                        >Resources</span
                      >
                      {{ $course->resources }}
                    </li>
                    ...
                    >
                      <span
                        ><i class="la la-lightbulb me-2 text-color"></i>Skill
                        level</span
                      >
                      {{ $course->label }}
                    </li>
