        ...
        <div class="breadcrumb-content">
          <div class="media media-card align-items-center pb-4">
            <div class="media-img media--img media-img-md rounded-full">
              <img
                class="rounded-full"
                src="{{ (!empty($instructor->photo)) ? url('upload/instructor-images/'.$instructor->photo) : url('frontend/images/img-loading.png') }}"
              ...
              <div class="card card-item">
                <div class="card-body">
                  ...
                  <a
                    ...
                    href="#collapseReadMore"
                    role="button"
                    aria-expanded="false"
                    aria-controls="collapseReadMore"
                  >
                    <span class="collapse-btn-hide"
                      >Read more<i class="la la-angle-down ms-1 fs-14"></i
                    ></span>
                    <span class="collapse-btn-show"
                      >Read less<i class="la la-angle-up ms-1 fs-14"></i
                    ></span>
                  </a>
                </div>
              </div>
              ...
              <div class="card card-item">
                <div class="card-body">
                  <p>
                    ...
                    form, by injected humour, or randomised words which don't
                    look even slightly believable. Lorem ipsum dolor sit amet,
                    consectetur adipisicing elit. cupiditate deleniti eius, ex
                    fuga iusto minus, nihil perspiciatis porro provident quasi
                    soluta ut! Consequuntur earum eos magnam?
                  </p>
                  <div class="skills-wrap pt-30px">
                    <div class="skills">
                      <div class="skill">
                        ...
                        >
                          <span
                            class="fs-16 text-black font-weight-semi-bold pe-3"
                            >HTML</span
                          >
                          <span>99%</span>
                        </div>
