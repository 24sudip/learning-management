    ...
    <section class="course-area section--padding">
      <div class="container">
        <div class="filter-bar mb-4">
          ...
          >
            <p class="fs-14">
              We found <span class="text-black">{{ count($courses) }}</span> courses available for
              you
            </p>
                  ...
                  <div class="custom-control custom-radio mb-1 fs-15">
                    ...
                    >
                      <span class="rating-wrap d-flex align-items-center">
                        ...
                        <span class="rating-total ps-1"
                          ><span class="me-1 text-black">5.0</span
                          >(20,230)</span
                        >
                      </span>
                    </label>
                  ...
                  <div class="custom-control custom-radio mb-1 fs-15">
                    ...
                    >
                      <span class="rating-wrap d-flex align-items-center">
                        ...
                        <span class="rating-total ps-1"
                          ><span class="me-1 text-black">4.5 & up</span
                          >(10,230)</span
                        >
                      </span>
                    </label>
                  ...
                  <div class="custom-control custom-radio mb-1 fs-15">
                    ...
                    >
                      <span class="rating-wrap d-flex align-items-center">
                        ...
                        <span class="rating-total ps-1"
                          ><span class="me-1 text-black">3.0 & up</span
                          >(7,230)</span
                        >
                      </span>
                    </label>
                  ...
                  <div class="custom-control custom-radio mb-1 fs-15">
                    ...
                    >
                      <span class="rating-wrap d-flex align-items-center">
                        ...
                        <span class="rating-total ps-1"
                          ><span class="me-1 text-black">2.0 & up</span
                          >(5,230)</span
                        >
                      </span>
                    </label>
                  ...
                  <div class="custom-control custom-radio mb-1 fs-15">
                    ...
                    >
                      <span class="rating-wrap d-flex align-items-center">
                        ...
                        <span class="rating-total ps-1"
                          ><span class="me-1 text-black">1.0 & up</span
                          >(3,230)</span
                        >
                      </span>
                    </label>
                  ...
                  <div class="collapse" id="collapseMore">
                    <div class="custom-control custom-checkbox mb-1 fs-15">
                      ...
                      <label
                        ...
                        for="catCheckbox5"
                      >
                        Graphic Design<span class="ms-1 text-gray"
                          >(12,300)</span
                        >
                      </label>
                    </div>
                    ...
                    <div class="custom-control custom-checkbox mb-1 fs-15">
                      ...
                      <label
                        ...
                        for="catCheckbox7"
                      >
                        Web Development<span class="ms-1 text-gray"
                          >(12,300)</span
                        >
                      </label>
                    </div>
                  ...
                  <div class="card-image">
                    <a href="course-details.html" class="d-block">
                      <img
                        ...
                        data-src="{{ asset('frontend/images') }}/img8.jpg"
                        alt="Card image cap"
                      />
                    </a>
                  ...
                  <div class="card-image">
                    <a href="course-details.html" class="d-block">
                      <img
                        class="card-img-top lazy"
                        src="{{ asset('frontend/images') }}/img-loading.png"
                        data-src="{{ asset('frontend/images') }}/img9.jpg"
                        alt="Card image cap"
                      />
                    </a>
                    <div class="course-badge-labels">
                  ...
                  <div class="card-image">
                    <a href="course-details.html" class="d-block">
                      <img
                        class="card-img-top lazy"
                        src="{{ asset('frontend/images') }}/img-loading.png"
                        data-src="{{ asset('frontend/images') }}/img10.jpg"
                        alt="Card image cap"
                      />
                    </a>
                  </div>
                  ...
                  <div class="card-image">
                    <a href="course-details.html" class="d-block">
                      <img
                        class="card-img-top lazy"
                        src="{{ asset('frontend/images') }}/img-loading.png"
                        data-src="{{ asset('frontend/images') }}/img11.jpg"
                        alt="Card image cap"
                      />
                    </a>
                  </div>
                  ...
                  <div class="card-image">
                    <a href="course-details.html" class="d-block">
                      <img
                        class="card-img-top lazy"
                        src="{{ asset('frontend/images') }}/img-loading.png"
                        data-src="{{ asset('frontend/images') }}/img12.jpg"
                        alt="Card image cap"
                      />
                    </a>
                    <div class="course-badge-labels">
