      ...
      <div class="container">
        <div class="breadcrumb-content">
          ...
          >
            ...
            <li class="d-flex align-items-center">{{ $blog_post->created_at->format('M d Y') }}</li>
            <li class="d-flex align-items-center">
              <a href="#comments" class="page-scroll">4 Comments</a>
            </li>
          ...
          <div class="col-lg-8 mb-5">
              ...
              <div class="card-body">
                ...
                >
                  <ul class="generic-list-item generic-list-item-boxed d-flex flex-wrap fs-15">
                    ...
                    <li class="me-2"><a href="#">{{ ucwords($tag) }}</a></li>
                    @endforeach
                  </ul>
            ...
            <div class="instructor-wrap py-5">
              ...
              <div class="media media-card">
                <div class="media-img rounded-full avatar-lg me-4">
                  <img
                ...
                <div class="media-body">
                  ...
                  <p class="pb-3">
                    I'm a growth-oriented digital marketer with a passion for
                    content marketing, social media marketing wonders,
                    conversion rate optimization, and keyword research. I
                    strongly support permission marketing and earned media. More
                    than anything
                  </p>
                  <ul
            ...
            <div class="comments-wrap pt-5" id="comments">
              ...
              <div class="comment-list">
                ...
                >
                  ...
                  <div class="media-body">
                    ...
                    <p class="pb-3">
                      This is one of the best courses I have taken in Udemy. It
                      is very complete, and it has made continue learning about
                      Java and SQL databases as well.
                    </p>
                    <div
                    ...
                    >
                      <a
                        ...
                        ><i class="la la-reply me-1"></i> Reply</a
                      >
                      <div class="ps-2">
                ...
                <!-- end media -->
                <div
                  class="media media-card border-bottom border-bottom-gray pb-4 mb-4 review-reply"
                >
                  <div class="media-img me-4 rounded-full">
                    <img
                      class="rounded-full lazy"
              ...
              <div class="load-more-btn-box text-center pt-3 pb-5">
                <button
                  class="btn theme-btn theme-btn-sm theme-btn-transparent lh-30"
                >
                  <i class="la la-refresh me-1"></i> Load More Comment
                </button>
              </div>
            </div>
            <div class="section-block"></div>
              ...
              <div class="card card-item">
                <div class="card-body">
                  ...
                  >
                    ...
                    <li class="me-2"><a href="#">Event</a></li>
                    <li class="me-2"><a href="#">Video</a></li>
                    <li class="me-2"><a href="#">Audio</a></li>
                    <li class="me-2"><a href="#">Software</a></li>
                    <li class="me-2"><a href="#">Conference</a></li>
                    ...
                    <li class="me-2"><a href="#">Entrepreneur</a></li>
                  </ul>
                </div>
              </div>
              <!-- end card -->
