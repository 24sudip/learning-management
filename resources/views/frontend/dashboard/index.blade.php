...
<div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
    ...
    {{-- <div class="file-upload-wrap file-upload-wrap-2 file--upload-wrap">
        ...
        <span class="file-upload-text"
            ><i class="la la-upload me-2"></i>Upload a course</span
        >
    </div> --}}
    <!-- file-upload-wrap -->
</div>
...
<div class="row">
    ...
    {{-- <div class="col-lg-4">
        <div class="card card-item">
            <div class="card-body">
            <h3 class="fs-18 font-weight-semi-bold pb-4">
                Earning by Location
            </h3>
            <div class="my-course-progress-bar-wrap">
                ...
                <div
                class="d-flex flex-wrap align-items-center mb-2 position-relative"
                >
    ...
    {{-- <div class="col-lg-5 responsive-column-half">
        <div class="card card-item">
            ...
            <div
                class="notification-body scrolled-box custom-scrollbar-styled"
            >
                <a
                href="dashboard.html"
                ...
                <div class="media-body">
                    ...
                    <span class="d-block lh-18 pt-1 text-gray fs-13"
                    >1 hour ago</span
                    >
                </div>
                </a>
                ...
                >
                <div
                    class="icon-element icon-element-sm flex-shrink-0 bg-4 me-3 text-white"
                >
                    <i class="la la-lock"></i>
                </div>
                <div class="media-body">
                ...
                >
                <div
                    class="icon-element icon-element-sm flex-shrink-0 bg-5 me-3 text-white"
                >
                    <i class="la la-user"></i>
                </div>
                <div class="media-body">
                ...
                >
                <div
                    class="icon-element icon-element-sm flex-shrink-0 bg-6 me-3 text-white"
                >
                ...
                >
                <div
                    class="icon-element icon-element-sm flex-shrink-0 bg-7 me-3 text-white"
                >
