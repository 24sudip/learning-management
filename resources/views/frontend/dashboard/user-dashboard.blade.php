...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from techydevs.com/demos/themes/html/aduca-demo/aduca/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 11:25:15 GMT -->
<head>
...
START HEADER AREA
======================================-->
    @include('frontend.dashboard.layout.header')
<!--======================================
END HEADER AREA
======================================-->
    ...
    <section class="dashboard-area">
        ...
        <div class="dashboard-content-wrap">
            ...
            <div class="container-fluid">
                ...
                @include('frontend.dashboard.layout.footer')
            </div>
            <!-- end container-fluid -->
        </div>
