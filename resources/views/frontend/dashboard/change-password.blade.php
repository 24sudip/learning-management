...
<div class="tab-pane fade show active" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
    <div class="setting-body">
        ...
        <form method="post" class="row pt-40px" action="{{ route('user.password.update') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="input-box col-lg-12">
                ...
                <div class="form-group">
                    <input
                        class="form-control form--control @error('new_password') is-invalid @enderror"
                        type="password"
