...
@include('frontend.my-course.lesson-body.header')
      ...
      <div class="header-menu-content bg-dark">
        <div class="container-fluid">
          <div class="main-menu-content d-flex align-items-center">
            ...
            <!-- end logo-box -->
            <div class="course-dashboard-header-title ps-4">
              <a href="course-details.html" class="text-white fs-15"
                >{{ $order->course->course_name }}</a
              >
            </div>
            <!-- end course-dashboard-header-title -->
            <div class="menu-wrapper ms-auto">
              <div class="theme-picker d-flex align-items-center me-3">
                <button
                  class="theme-picker-btn dark-mode-btn"
                  title="Dark mode"
                >
              ...
              <div class="nav-right-button d-flex align-items-center">
                <a
                  href="#"
                  class="btn theme-btn theme-btn-sm theme-btn-transparent lh-26 text-white me-2"
                  data-bs-toggle="modal"
                  data-bs-target="#ratingModal"
                  ><i class="la la-star me-1"></i> leave a rating</a
                >
                <a
                  href="#"
                  class="btn theme-btn theme-btn-sm theme-btn-transparent lh-26 text-white me-2"
        ...
        <div class="course-dashboard-container d-flex">
          <div class="course-dashboard-column">
            ...
            <div class="lecture-viewer-container">
              <div class="lecture-video-item">
                ...
                <div class="fs-24 font-weight-semi-bold pb-2 text-center mt-4" id="textLesson">
                    <h3></h3>
                </div>
              </div>
                ...
                <div class="tab-content" id="myTabContent">
                  ...
                  >
                    <div class="search-course-wrap pt-40px">
                      ...
                      <div class="search-results-message text-center">
                        <h3 class="fs-24 font-weight-semi-bold pb-1">
                          Start a new search
                        </h3>
                  ...
                  >
                    <div class="mobile-course-menu pt-4">
                      <div
                        class="accordion generic-accordion generic--accordion"
                        ...
                        <div class="card">
                          <div class="card-header" id="mobileCourseHeadingOne">
                            <button
                              ...
                              data-bs-target="#mobileCourseCollapseOne"
                              aria-expanded="true"
                            ...
                            >
                              ...
                              <span class="fs-15">
                                Section 1: Dive in and Discover After
                                Effects</span
                              >
                          ...
                          <div
                            ...
                            data-bs-parent="#mobileCourseAccordionCourseExample"
                          >
                                    ...
                                    <div class="course-item-content">
                                      ...
                                      <div class="courser-item-meta-wrap">
                                        <p class="course-item-meta">
                                          <i class="la la-play-circle"></i>2min
                                        </p>
                                      </div>
                                    </div>
                                ...
                                <li class="course-item-link active-resource">
                                  <div class="course-item-content-wrap">
                                    <div class="custom-control custom-checkbox">
                                      ...
                                      <label
                                        class="custom-control-label custom--control-label"
                                        for="mobileCourseCheckbox3"
                                      ></label>
                                    </div>
                                    <!-- end custom-control -->
                                    <div class="course-item-content">
                                      <h4 class="fs-15">
                                        3. Download your Footage for your Quick
                                        Start
                                      </h4>
                                      <div class="courser-item-meta-wrap">
                                        <p class="course-item-meta">
                                          <i class="la la-file"></i>2min
                                        </p>
                                        <div class="generic-action-wrap">
                                          <div class="dropdown">
                                            ...
                                            >
                                              <i
                                                class="la la-folder-open me-1"
                                              ></i>
                                              Resources<i
                                                class="la la-angle-down ms-1"
                                              ></i>
                                            </a>
                                            <div
                                              class="dropdown-menu dropdown-menu-right"
                                ...
                                <li class="course-item-link">
                                  <div class="course-item-content-wrap">
                                    <div class="custom-control custom-checkbox">
                                      ...
                                      <label
                                        class="custom-control-label custom--control-label"
                                        for="mobileCourseCheckbox4"
                                      ></label>
                                    </div>
                                    <!-- end custom-control -->
                                    <div class="course-item-content">
                                      <h4 class="fs-15">
                                        4. Jump in and Animate your Character
                                      </h4>
                                      <div class="courser-item-meta-wrap">
                                        <p class="course-item-meta">
                                          <i class="la la-play-circle"></i>2min
                    ...
                    <div class="lecture-overview-wrap">
                        ...
                        <div class="lecture-overview-stats-wrap d-flex">
                          ...
                          <div class="lecture-overview-stats-item">
                            <ul class="generic-list-item">
                              <li><span>Skill level:</span>{{ $order->course->label }}</li>
                          ...
                          <div class="lecture-overview-stats-item">
                            <ul class="generic-list-item">
                              <li><span>Resources:</span>{{ $order->course->resources }}</li>
                              <li><span>Video length:</span>{{ $order->course->duration }} total hours</li>
                              <li><span>Certificate:</span>{{ $order->course->certificate }}</li>
                            </ul>
                          </div>
                          <!-- end lecture-overview-stats-item -->
                        </div>
                      ...
                      <div class="lecture-overview-item">
                        <div class="lecture-overview-stats-wrap d-flex">
                          ...
                          >
                            <p class="pb-3">
                              Get Aduca certificate by completing entire course
                            </p>
                            <a
                              href="#"
                      ...
                      <div class="lecture-overview-item">
                        <div class="lecture-overview-stats-wrap d-flex">
                          ...
                          >
                            <h3 class="fs-16 font-weight-semi-bold pb-2">
                              From the Author of the Best Selling After Effects
                              CC 2020 Complete Course
                            </h3>
                            <p>
                  ...
                  >
                    <div class="lecture-overview-wrap lecture-quest-wrap">
                      <div class="new-question-wrap">
                        <button
                          class="btn theme-btn theme-btn-transparent back-to-question-btn"
                        >
                          <i class="la la-reply me-1"></i>Back to all questions
                        </button>
                    ...
                    >
                      <div class="lecture-overview-item">
                        ...
                        <div class="lecture-owner-decription pt-4">
                          ...
                          <p>
                            Happy 2019 to everyone, thank you for being a
                            student and all of your support.
                          </p>
                          <p>
                            <strong
                              >Great job on enrolling and your current course
                              progress. I encourage you keep in pursuit of your
                              dreams :)</strong
                            >
                          </p>
                          <p>
                            The whole lot. In my course After Effects Complete
                            Course packed with all Techniques and Methods (No
                            Tricks and gimmicks).
                          </p>
                          <p class="font-italic">
                            <strong
                              >Unfortunately this will result in delayed
                              responses by me in the Q&A section and to direct
                              messages. This is only for the next week and once
                              back I will be back to 100% .</strong
                            >
                          </p>
                          <p>
                            I will continue to do my best to respond to as many
                            questions as possible but only one person, regularly
                            I spend 4-5 hours daily on this and with over 440000
                            students as you can image that its a lot of work.
                          </p>
                          <p class="font-italic">
                            Thank you once again for your understanding and for
                            all of the wonderful students who I have had an
                            opportunity to communicate with regularly and all of
                            your encouragement.
                          </p>
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-lg-6">
                    <div class="client-logo-wrap text-end">
                      <a
                        href="#"
                        class="client-logo-item client--logo-item-2 pe-3"
                        ><img src="{{ asset('frontend/images') }}/sponsor-img.png" alt="brand image"
                      /></a>
                      <a
                        href="#"
                        class="client-logo-item client--logo-item-2 pe-3"
                        ><img src="{{ asset('frontend/images') }}/sponsor-img2.png" alt="brand image"
                      /></a>
                      <a
                        href="#"
                        class="client-logo-item client--logo-item-2 pe-3"
                        ><img src="{{ asset('frontend/images') }}/sponsor-img3.png" alt="brand image"
                      /></a>
                    </div>
            ...
            <div class="footer-area pt-50px">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-lg-3 responsive-column-half">
                    <div class="footer-item">
                      <h3 class="fs-20 font-weight-semi-bold pb-3">
                        Download App
                      </h3>
              ...
              <!-- end container-fluid -->
              <div class="section-block"></div>
              <div class="copyright-content px-4 py-4">
                <div class="container-fluid">
                  <div class="row align-items-center">
                    <div class="col-lg-6">
                      <p class="copy-desc">
          ...
          <div class="course-dashboard-sidebar-column">
            <button class="sidebar-open" type="button">
              <i class="la la-angle-left"></i> Course content
            </button>
            <div class="course-dashboard-sidebar-wrap custom-scrollbar-styled">
              ...
              <div class="course-dashboard-side-content">
                <div class="accordion generic-accordion generic--accordion" id="accordionCourseExample">
                    ...
                    <div class="card">
                        @php
                            $course_lectures = App\Models\CourseLecture::where('section_id', $course_section->id)->get();
                        @endphp
                      <div class="card-header" id="headingOne{{ $course_section->id }}">
                        <button
                          class="btn btn-link"
                          type="button"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapseOne{{ $course_section->id }}"
                          aria-expanded="true"
                        ...
                        >
                          ...
                          <span class="course-duration">
                            <span>({{ count($course_lectures) }})</span>
                          </span>
                        </button>
                      </div>
                      <!-- end card-header -->
                      <div
                        id="collapseOne{{ $course_section->id }}"
                        class="collapse"
                        aria-labelledby="headingOne{{ $course_section->id }}"
                        data-bs-parent="#accordionCourseExample"
                      >
                        <div class="card-body p-0">
                          <ul class="curriculum-sidebar-list">
                            ...
                            <li class="course-item-link active">
                              <div class="course-item-content-wrap">
                                ...
                                <!-- end custom-control -->
                                <div class="course-item-content">
                                  <h4 class="fs-15 lecture-title" data-video-url="{{ $course_lecture->url }}" data-content="{!! $course_lecture->content !!}">
...
======================================-->
    ...
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header border-bottom-gray align-items-start">
            <div class="pe-2">
              <h5
                class="modal-title fs-19 font-weight-semi-bold lh-24"
          ...
          <div class="modal-body select-model">
            <form method="post ">
              <div class="input-box select2-full-wrapper">
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="insertLinkModalTitle"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="#">
              ...
              <div class="btn-box text-end pt-2">
                ...
                <button type="submit" class="btn theme-btn theme-btn-sm lh-30">
                  Insert <i class="la la-arrow-right icon ms-1"></i>
                </button>
              </div>
            </form>
          </div>
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="uploadPhotoModalTitle"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="file-upload-wrap">
              ...
              <span class="file-upload-text"
                ><i class="la la-upload me-2"></i>Drop files here or click to
                upload</span
              >
            </div>
            <!-- file-upload-wrap -->
    ...
    @include('frontend.my-course.lesson-body.footer')
  </body>

<!-- Mirrored from techydevs.com/demos/themes/html/aduca-demo/aduca/lesson-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 11:25:13 GMT -->
</html>
