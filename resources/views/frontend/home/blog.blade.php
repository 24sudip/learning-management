            ...
            <div class="card-body">
              <h5 class="card-title">
                <a href="blog-single.html"
                  >Sales Training: Practical Techniques</a
                >
              </h5>
              <ul
          ...
          <div class="card card-item">
            <div class="card-image">
              <a href="blog-single.html" class="d-block">
                <img
                  class="card-img-top"
                  src="{{ asset('frontend/images') }}/img10.jpg"
                  alt="Card image cap"
                />
              </a>
              <div class="course-badge-labels">
          ...
          <div class="card card-item">
            <div class="card-image">
              <a href="blog-single.html" class="d-block">
                <img
                  class="card-img-top"
                  src="{{ asset('frontend/images') }}/img11.jpg"
                  alt="Card image cap"
                />
              </a>
              <div class="course-badge-labels">
          ...
          <div class="card card-item">
            <div class="card-image">
              <a href="blog-single.html" class="d-block">
                <img
                  class="card-img-top"
                  src="{{ asset('frontend/images') }}/img12.jpg"
                  alt="Card image cap"
                />
              </a>
              <div class="course-badge-labels">
          ...
          <div class="card card-item">
            <div class="card-image">
              <a href="blog-single.html" class="d-block">
                <img
                  class="card-img-top"
                  src="{{ asset('frontend/images') }}/img13.jpg"
                  alt="Card image cap"
                />
              </a>
              <div class="course-badge-labels">
