...
<div class="page-content">
    <div class="row">
        <div class="col-12">
            ...
            @foreach ($course_sections as $key => $item)
            <div class="container">
                <div class="main-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body p-4 d-flex justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        &nbsp; &nbsp;
                                        <a onclick="addLectureDiv({{ $course->id }},{{ $item->id }},'lectureContainer{{ $key }}')" class="btn btn-primary" id="addLectureBtn{{ $key }}">Add Lecture</a>
                                    </div>
                                </div>
                                <div class="courseHide" id="lectureContainer{{ $key }}">
                                    <div class="container">
                                        @foreach ($item->course_lectures as $lecture)
                                        <div class="lectureDiv mb-3 d-flex justify-content-between align-items-center">
                                            <div class="">
            ...
            <div class="modal-body">
                <form action="{{ route('add.course.section') }}" method="post">
                    ...
                    <div class="form-group mb-3">
                        <label for="inputFirstName" class="form-label">Course Section</label>
                        <input type="text" class="form-control" id="inputFirstName" name="section_title">
                    </div>
