...
<h3>Product</h3>
  ...
  <table width="100%">
    ...
    <tbody>
        ...
        <tr class="font">
            <td align="center">
                <img src="{{ public_path($order->course->course_image) }}" width="60">
            </td>
            <td align="center">{{ $order->course->course_name }}</td>
  ...
  <table width="100%" style="padding: 0 10px 0 10px;">
    <tr>
        <td align="right">
            <h2>
                <span style="color: green;">Subtotal:</span>{{ $payment->total_amount }}
            </h2>
            <h2>
                <span style="color: green;">Total:</span>{{ $payment->total_amount }}
            </h2>
        </td>
    </tr>
  </table>
