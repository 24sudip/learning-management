...
<div class="page-content">
    ...
    <div class="card border-top border-primary">
        <div class="card-body p-5">
            ...
            <hr>
            <form id="myForm" class="row g-3" action="{{ route('update.subcategory', $sub_category->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputFirstName" name="sub_category_name" value="{{ $sub_category->sub_category_name }}">
                </div>
                <div class="col-12">
